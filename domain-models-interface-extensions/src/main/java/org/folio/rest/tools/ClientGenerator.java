...
public class ClientGenerator {
  ...
  public ClientGenerator(String interfacePackage) {
  ...
  public static void main(String[] args) throws Exception {
    ...
    AnnotationGrabber.generateMappings(true, interfacePackage);
  }
  ...
  private void addCommentAutogenerated(JMethod method) {
    String resourceName = interfacePackage + "." + className + "Resource";
  ...
  public void generateClassMeta(String className) {
    ...
    try {
      ...
      this.className = className.substring(interfacePackage.length() + 1);
